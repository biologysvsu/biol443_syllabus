...
4. [MATERIALS REQUIRED](#MATERIALS-REQUIRED)
5. [GRADING POLICY](#GRADING-POLICY)
6. [MAKEUP WORK AND ATTENDANCE POLICY](#MAKEUP-WORK-AND-ATTENDANCE-POLICY)
...
| Week 7         | Oct 15       | Amplicon Sequencing Analysis **(Midterm 1)**           | Microbiome diversity. Identifying and removing chimeras.                                                                   |
| Week 8         | Oct 22        | No Class                                         | Spring Break.                                                                                                                                     |
| Week 9         | Oct 29       | Transcriptomics                                     | Tools: HISAT2/STAR for alignment, StringTie for transcript assembly. Hands-on: Process RNA-seq data.                                           |
...
| Week 13        | Nov 26       | Data Analysis and Visualization **(Midterm 2)**                  | Basics of R and RStudio. Hands-on: Visualize gene expression data.|
